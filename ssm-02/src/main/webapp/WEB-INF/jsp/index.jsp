...
<head>
    ...
    <meta name="viewport" content="widnth=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <link href="${pageCotext.request.contextPath}/asserts/css/signin.css" rel="stylesheet">
</head>
